...
const getNGonSideCount = splitCount => {
  ...
  const nGonSideCount = hexagonSidesCount * (splitCount ? 2 ** splitCount : 1);
  return nGonSideCount;
}

export const liuHui = (splitCount = 1) => {
  ...
  const pie = approximateCircleArea / (circleRadius ** 2);
  return pie;
}
